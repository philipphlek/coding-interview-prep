...
which is the speed that they pedal a tandem bicycle at. Both lists have the same length, 
...
bicycles being ridden based on an input parameter, `fastest`. If `fastest = true`, 
...
who have speeds of `1, 3, 4, 5`, and if they're paired on tandem bicycles as follows: `[1, 4], [5, 3]`, 
...
Sample Output
32 // since there are 5 tandem bicycles, and the 5 tandem bicycles that can be formed by 
combining every rider are `[5, 2], [5, 3], [3, 7], [9, 2], [2, 1]`. 
The total speed of these tandem bicycles is `5 + 5 + 7 + 9 + 2 = 32`.
*/
